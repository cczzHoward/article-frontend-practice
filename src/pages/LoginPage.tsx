        ...
        <div className="min-h-screen bg-background flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                <div className="bg-surface border border-slate-700 rounded-lg p-8 shadow-lg">
                    <Link
                        to="/"
                        className="flex items-center gap-2 justify-center text-3xl font-bold text-slate-100 hover:text-primary transition-colors mb-2"
                    >
                        InkFlow
                    </Link>
                    <p className="text-slate-400 mb-8 text-center">Login to your account</p>
